...
BeginPackage["FiniteFlow32`"]


$FFVersion::usage = "$FFVersion is the major version of FiniteFlow32 (see also $FFVersionMinor)."
$FFVersionMinor::usage = "$FFVersionMinor is the minor version of FiniteFlow32 (see also $FFVersion)."

FFInt64Max::usage = "Maximum 64-bit integer."

FFLoadLib::usage = "FFLoadLib[] (re)loads the finiteflow32 library."
...
FFSerializeSparseEqs::usage="FFSerializeSparseEqs[filename, params, eqs, vars, pattern, position] serializes the equations eqs in \"MX\" format in the file filename, formatted for communication with the finiteflow32 library."
...
FFNAvailablePrimes::usage = "FFNAvailablePrimes[] returns the number of primes available in FiniteFlow32, i.e. the maximum allowed argument for FFPrimeNo."
...
FFLoadLib[] := Module[
    {},
    fflowlib = FindLibrary["finiteflow32mlink"];
